...
namespace PRS_Backend.Controllers
{
    ...
    public class RequestLinesController : ControllerBase
    {
        ...
        {
            return await _context.RequestLines.Include(x => x.Products).ToListAsync();
        }
        ...
        public async Task<IActionResult> PutRequestLine(int id, RequestLine requestLine)
        {
            ...
            try
            {
                ...
                await RecalculateOrderTotal(requestLine.RequestId);
            }
        ...
        public async Task<IActionResult> DeleteRequestLine(int id)
        {
            ...
            await RecalculateOrderTotal(requestId);
        ...
        private async Task<IActionResult> RecalculateOrderTotal(int requestId)
        {
